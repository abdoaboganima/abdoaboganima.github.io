document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "edu-minia-grade": "Cumulative Grade: Excellent with Honor (GPA: 3.7/4.0, German: 1.79)",
    ...
    de: {
      ...
      "current-position-title": "Aktuelle Position",
      "job-title": "Embedded Softwareentwickler",
      "job-period": "(Nov. 2022 – Heute)",
      ...
      "edu-minia-grade": "Gesamtnote: Ausgezeichnet mit Auszeichnung (GPA: 3,7/4,0, Deutsch: 1,79)",
